        ...
        <div class="container md:ml-20 ">
            <div class="md:flex">
                <div class="flex w-full justify-center px-4 md:w-1/2 md:order-2">
                    <div class="">
                        <img src="img/MASKOT BADMINTON.svg" alt="Logo BuluTangkis" class="mx-auto items-center self-center">
                    </div>
                </div>
