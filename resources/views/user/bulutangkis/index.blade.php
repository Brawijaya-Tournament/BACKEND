        ...
        <div class="container mx-auto">
            <div class="flex flex-wrap">
                <div class="flex justify-center w-full  px-4 lg:w-1/2 md:order-2">
                    <div class=" lg:mt-24 ">
                        <img src="img/MASKOT BADMINTON.svg" alt="Logo BuluTangkis" class="max-w-full mx-auto">
                    </div>
                </div>
                <div class="w-full self-center px-4 lg:w-1/2">
                    ...
                    <h1 class="text-center md:text-left font-silverkids font-normal text-5xl lg:text-6xl leading-10 text-secondary2 uppercase mt-5 lg:mt-0 mb-5 md:py-4" style="text-shadow: 2px 2px 2px #D7137D;">Bulutangkis</h1>
                    <p class="text-justify md:text-left font-poppins font-normal text-base text-white leading-6 mb-10">Bulutangkis atau badminton adalah suatu olahraga yang menggunakan alat berbentuk bulat yang memiliki rongga-rongga di bagian pemukulnya dan memiliki gagang. Alat ini dikenal dengan nama raket yang dimainkan oleh dua orang atau dua pasangan yang saling berlawanan.</p>
        ...
        <div class="container mx-auto w-full h-full">
            <div class="p-10 h-full">
                ...
                <div class="flex justify-center pb-10">
                    <img src="img/timelineBultang-laptop.svg" alt="">
                </div>
            </div>
        </div>
    </section>
