...
@section('container') 
            ...
            <div class="md:grid md:grid-cols-1 ">
                ...
                <div class="grid-2 md:grid-3 col-span-2 p-10 mb-20">
                    ...
                    @endif
                 <!-- form informasi tim -->
                 <form method="post" action="/bulutangkis-ganda/register" class="mb-5" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="official pt-5">
                        <p class="pt-4 font-bold pb-2 text-lg text-secondary2">INFORMASI PEMAIN</p>
                        <hr class="mb-5">
                        <!-- row1 -->
