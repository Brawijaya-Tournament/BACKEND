    ...
    <div class="container md:ml-20 ">
            <div class="md:flex">
                <div class="flex w-full justify-center px-4 md:w-1/2 md:order-2">
                    <div class="">
                        <img src="img/MASKOT BT SOLO VOCAL.svg" alt="Logo BuluTangkis" class="mx-auto items-center self-center">
                    </div>
                </div>
                <div class="w-full self-center px-4 lg:w-1/2 md:order-1">
                    ...
                    <div class="lg:flex lg:items-center lg:space-x-2 pb-10 md:pb-0">
                        ...
                        <div class=" bg-transparent border border-secondary2 rounded-xl py-3 px-8 text-center">
                            <a href="https://docs.google.com/file/d/15IPVb0fBQ-C3nP2690nDUPMgeYpWNIs3/edit?usp=docslist_api&filetype=msword" target="_blank" class="font-poppins font-bold text-lg leading-5 text-secondary2  hover:shadow-lg hover:bg-primary3 transition duration-300 ease-in-out">Download Rulebook</a>
                        </div>
                    </div>
                </div>
