        ...
        <div class="container mx-auto">
            <div class="flex flex-wrap">
                <div class="flex justify-center w-full  px-4 lg:w-1/2 md:order-2">
                    <div class=" lg:mt-24 ">
                        <img src="img/MASKOT PUBG.svg" alt="Logo BuluTangkis" class="max-w-full mx-auto">
                    </div>
                </div>
                <div class="w-full self-center px-4 lg:w-1/2">
                    ...
                    <h1 class="text-center md:text-left font-silverkids font-normal text-5xl lg:text-6xl leading-10 text-secondary2 uppercase mt-5 lg:mt-0 mb-5 md:py-4" style="text-shadow: 2px 2px 2px #D7137D;">PUBG</h1>
                    <p class="text-justify md:text-left font-poppins font-normal text-base text-white leading-6 mb-10">PUBG adalah singkatan dari PlayerUnknown’s Battlegrounds yang dapat dimainkan secara solo maupun tim. Brawijaya Tournament akan mempertandingkan antar tim yang bermain secara daring di aplikasi PUBG (PlayerUnknown's Battlegrounds) tersebut</p>
