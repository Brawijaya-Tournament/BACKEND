            ...
            <div class="md:grid md:grid-cols-1 ">
                ...
                <div class="grid-2 md:grid-3 col-span-2 p-10 mb-20">
                    <div class="flex items-center ">
                        ...
                        <p class="text-white font-bold text-2xl px-3">PENDAFTARAN FUTSAL</p>
                    </div>
                    ...
                    @endif
                 <!-- form informasi tim -->
                 <form method="post" action="/futsal/register" class="mb-5" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="md:flex md:mt-auto py-4 text-white justify-center md:pl-12 pr-10 md:justify-between">
                                <div class="w-full md:w-[50%] md:pr-10">
                                    ...
                                    <ol class="list-decimal md:pl-4 md:space-y-2 md:pr-10">
                                        ...
                                        <li>Unduh Rulebook
                                            <a href="https://docs.google.com/document/d/1d0vkcCCZG8sbvXf1oRuFfGZ8UhawEdXm/edit#"
