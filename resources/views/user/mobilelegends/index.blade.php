        ...
        <div class="container mx-auto">
            <div class="flex flex-wrap">
                <div class="flex justify-center w-full  px-4 lg:w-1/2 md:order-2">
                    <div class=" lg:mt-24 ">
                        <img src="img/MASKOT BT ML.svg" alt="Logo BuluTangkis" class="max-w-full mx-auto">
                    </div>
                </div>
                <div class="w-full self-center px-4 lg:w-1/2">
                    ...
                    <h1 class="text-center md:text-left font-silverkids font-normal text-5xl lg:text-6xl leading-10 text-secondary2 uppercase mt-5 lg:mt-0 mb-5 md:py-4" style="text-shadow: 2px 2px 2px #D7137D;">MOBILE LEGEND</h1>
                    <p class="text-justify md:text-left font-poppins font-normal text-base text-white leading-6 mb-10">Mobile Legend merupakan game yang dimainkan oleh dua tim lawan. Masing-masing tim terdapat lima pemain yang mengendalikan hero masing-masing dari perangkat mereka sendiri.</p>
