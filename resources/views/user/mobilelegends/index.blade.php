                ...
                <div class="w-full self-center px-4 lg:w-1/2">
                    ...
                    <div class="lg:flex lg:items-center lg:space-x-2 pb-10 md:pb-0">
                        ...
                        <div class=" bg-transparent border border-secondary2 rounded-xl py-3 px-8 text-center">
                            <a href="https://docs.google.com/file/d/18NM5ark6NuCI1-I61cO1yvwOKH9SibIz/edit?usp=docslist_api&filetype=msword" class="font-poppins font-bold text-lg leading-5 text-secondary2  hover:shadow-lg hover:bg-primary3 transition duration-300 ease-in-out">Download Rulebook</a>
                        </div>
                    </div>
                </div>
