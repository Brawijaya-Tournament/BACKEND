        ...
        <div class="container mx-auto">
            <div class="flex flex-wrap">
                ...
                <div class="w-full self-center px-4 lg:w-1/2">
                    ...
                    <h1 class="text-center md:text-left font-silverkids font-normal text-5xl lg:text-6xl leading-10 text-secondary2 uppercase mt-5 lg:mt-0 mb-5 md:py-4" style="text-shadow: 2px 2px 2px #D7137D;">FOTOGRAFI</h1>
                    <p class="text-justify md:text-left font-poppins font-normal text-base text-white leading-6 mb-10">Fotografi adalah sebuah karya visual berbentuk foto tentang suatu tema tertentu yang informatif dan mengandung makna khusus. Lomba ini meliputi proses pengambilan foto, editing minimal, hingga presentasi tentang makna foto yang diambil.</p>
