    ...
    <nav class="bg-primary2 sticky top-0 px-10 sm:px-4 py-2.5 shadow-lg">
        <div class="container flex flex-wrap justify-between items-center mx-auto">
            ...
            <div class="flex items-center space-x-2 md:order-2 mr-10">
                <button type="button" class="font-poppins font-bold text-lg leading-5 rounded-xl text-secondary2 bg-primary2 border-2 border-secondary2 hover:bg-secondary3 hover:text-primary3 focus:ring-4 focus:outline-none focus:ring-blue-300 px-5 py-2.5 text-center mr-10 md:mr-0 hidden lg:block sm:mx-auto"><a href="/register"> Daftar</a></button>
                <button type="button" class="font-poppins font-bold text-lg leading-5 rounded-xl text-primary2 bg-secondary2 hover:bg-primary3 hover:text-secondary3 border-2 border-secondary2 focus:ring-4 focus:outline-none focus:ring-blue-300 px-5 py-2.5 text-center mr-10 md:mr-0 hidden lg:block"><a href="/login"> Masuk</a></button>
                ...
                <ul class="flex flex-col p-6 mt-4 bg-primary2 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-primary2">
                    <li class="flex flex-cols">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="block lg:hidden h-6 w-6 self-center fill-secondary2">
                         ...
                         <button class="flex justify-between items-center py-2 pr-4 pl-3 text-secondary2 lg:text-natural7 rounded hover:bg-stone-200 md:hover:bg-transparent md:hover:text-secondary2 font-poppins font-medium text-lg leading-5 w-full md:border-0 md:p-0 md:w-auto active:border-none focus:border-none focus:outline-none active:outline-none"><a href="/"> Beranda</a>
                        </button>
                    </li class="flex flex-cols">
                    <li class="flex flex-cols">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="block lg:hidden h-6 w-6 self-center fill-secondary2">
                        ...
                        <div id="dropdownNavbar" class="hidden z-10 w-44 font-normal bg-primary3 rounded divide-y divide-gray-100 shadow active:border-none focus:border-none focus:outline-none active:outline-none">
                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                                <li>
                                    <a href="/bulutangkis" class="block py-2 px-4 font-poppins font-normal text-sm leading-4 text-secondary2 hover:bg-gray-100 ">Bulutangkis</a>
                                </li>
                                <li>
                                    <a href="/basket" class="block py-2 px-4 font-poppins font-normal text-sm leading-4 text-secondary2 hover:bg-gray-100 ">Basket</a>
                                </li>
                                <li>
                                    <a href="/futsal" class="block py-2 px-4 font-poppins font-normal text-sm leading-4 text-secondary2 hover:bg-gray-100">Futsal</a>
                                </li>
                                <li>
                                    <a href="/fotografi" class="block py-2 px-4 font-poppins font-normal text-sm leading-4 text-secondary2 hover:bg-gray-100 ">Fotografi</a>
                                </li>
                                <li>
                                    <a href="/solo-vocal" class="block py-2 px-4 font-poppins font-normal text-sm leading-4 text-secondary2 hover:bg-gray-100 ">Solo Vocal</a>
                                </li>
                                <li>
                                    <a href="/modern-dance" class="block py-2 px-4 font-poppins font-normal text-sm leading-4 text-secondary2 hover:bg-gray-100">Modern Dance</a>
                                </li>
                                <li>
                                    <a href="/mobilelegends" class="block py-2 px-4 font-poppins font-normal text-sm leading-4 text-secondary2 hover:bg-gray-100 ">Mobile Legends</a>
                                </li>
                                <li>
                                    <a href="/pubg" class="block py-2 px-4 font-poppins font-normal text-sm leading-4 text-secondary2 hover:bg-gray-100 ">PUBG Mobile</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li class="flex flex-cols" >
                        ...
                        <button class="flex justify-between items-center py-2 pr-4 pl-3 text-secondary2 lg:text-natural7 rounded hover:bg-stone-200 md:hover:bg-transparent md:hover:text-secondary2 font-poppins font-medium text-lg leading-5 w-full md:border-0 md:p-0 md:w-auto active:border-none focus:border-none focus:outline-none active:outline-none"><a href="/klasemen"> Klasemen</a> 
                    </li>
                    <li class="flex flex-cols">
                        ...
                        <button class="flex justify-between items-center py-2 pr-4 pl-3 text-secondary2 lg:text-natural7 rounded hover:bg-stone-200 md:hover:bg-transparent md:hover:text-secondary2 font-poppins font-medium text-lg leading-5 w-full md:border-0 md:p-0 md:w-auto active:border-none focus:border-none focus:outline-none active:outline-none"><a href="/faq"> FAQ</a> 
                    </li>
                    <li>
                        <button type="button" class="font-poppins font-bold text-lg leading-5 rounded-xl text-secondary2 bg-primary2 border-2 border-secondary2 hover:bg-secondary3 hover:text-primary3 focus:ring-4 focus:outline-none focus:ring-blue-300 px-5 py-2.5 mb-2 text-center mr-10 md:mr-0 w-full block lg:hidden sm:mx-auto"><a href="/register">Daftar</a></button>
                    </li>
                    <li>
                        <button type="button" class="font-poppins font-bold text-lg leading-5 rounded-xl text-primary2 bg-secondary2 hover:bg-primary3 hover:text-secondary3 border-2 border-secondary2 focus:ring-4 focus:outline-none focus:ring-blue-300 px-5 py-2.5 text-center mr-10 md:mr-0 w-full block lg:hidden"><a href="/login">Masuk</a></button>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="mx-auto lg:mx-20 py-10 text-center md:text-left md:flex md:justify-between">
            <div class="grid grid-cols-2 md:grid-cols-2 md:mb-0 sm:gap-6 sm:grid-cols-5 lg:grid-cols-5 gap-8">
                ...
                <div class="">
                    ...
                    <p>
                        <a href="/faq" class="text-primary2 font-poppins font-normal text-sm leading-4">FAQ</a>
                    </p>
                </div>
                <!-- grid 3 -->
                <div class="">
