                ...
                <div class="navbar-header" data-logobg="skin6">
                    <a class="navbar-brand" href="/dashboard">
                        ...
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="/assetss/img/Logo oke.svg" alt="homepage" class="dark-logo w-75" />
                            <!-- Light Logo text -->
                            {{-- <img src="/assets/images/logo-light-text.png" class="light-logo w-75" alt="homepage" /> --}}
                        </span>
                    </a>
                    <!-- ============================================================== -->
                    <!-- End Logo -->
        ...
        <aside class="left-sidebar" data-sidebarbg="skin6">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        @foreach (menuDashboardAdmin() as $value)
