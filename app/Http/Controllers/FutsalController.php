...
class FutsalController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('user.futsal.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if($request->nama13){
                $player13['nama'] = $request->nama13;
                $player13['nim']= $request->nim13;
                $player13['id_leader'] = auth()->user()->id;
                $player13['fakultas'] = $request->fakultas13;
                $player13['angkatan'] = $request->angkatan13;
                $player13['link_gdrive'] = $request->link_gdrive13;
                $player13['email'] = $request->email13;
                $player13['hp'] = $request->hp13;
                $player13['gender'] = $request->gender13;
                Player::create($player13);
            }

            if($request->nama14){
                $player14['nama'] = $request->nama14;
                $player14['nim']= $request->nim14;
                $player14['id_leader'] = auth()->user()->id;
                $player14['fakultas'] = $request->fakultas14;
                $player14['angkatan'] = $request->angkatan14;
                $player14['link_gdrive'] = $request->link_gdrive14;
                $player14['email'] = $request->email14;
                $player14['hp'] = $request->hp14;
                $player14['gender'] = $request->gender14;
